...
# Goose: Your On-Machine Developer Agent

Automating engineering tasks seamlessly within your IDE or terminal.

![Goose Drawing](./assets/goose.png)

Generated by Goose from its [VincentVanCode toolkit](https://github.com/block-open-source/goose-plugins/blob/main/src/goose_plugins/toolkits/artify.py).

[![Goose Documentation](https://img.shields.io/badge/Documentation-goose_docs-teal)](https://block.github.io/goose/)
[![Goose AI PyPI Version](https://img.shields.io/pypi/v/goose-ai?color=green)](https://pypi.org/project/goose-ai)
[![Apache 2.0 License](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![Join Discord](https://img.shields.io/discord/1287729918100246654?logo=discord&logoColor=white&label=Join+Discord&color=blueviolet)](https://discord.gg/7GaTvbDwga)

- [Unique features](#unique-features-of-goose-compared-to-other-ai-assistants)
- [Testimonials on Goose](#what-users-have-to-say-about-goose)
- [Quickstart guide](https://block.github.io/goose/quickstart.html)
